                    ...
                    <form action="/modifier-classement?id=<?php echo $classement['id_cla']; ?>" method="post">
                        <div class="mb-3">
                            ...
                            <input type="text"
                                ...
                                id="nom" name="cla_nomjoueur" value="<?php echo htmlspecialchars($cla_nomjoueur); ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number"
                                ...
                                id="rang" name="cla_rang" min="1" value="<?php echo htmlspecialchars($cla_rang); ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number"
                                ...
                                id="points" name="cla_points" value="<?php echo htmlspecialchars($cla_points); ?>">
