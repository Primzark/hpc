        ...
        <div class="form-section-bg rounded p-4 shadow">
          ...
          <form method="POST" action="">
            ...
            <div class="mb-3">
              ...
              <input type="password" class="form-control custom-add <?php if(!empty($errors['password'])) echo 'is-invalid'; ?>" id="password" name="password" placeholder="Entrez votre mot de passe">
            ...
            <div class="mb-3">
              ...
              <input type="password" class="form-control custom-add <?php if(!empty($errors['confirm_password'])) echo 'is-invalid'; ?>" id="confirm_password" name="confirm_password" placeholder="Confirmer le mot de passe">
